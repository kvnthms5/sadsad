    ...
    <div style="position: relative; top: 20px;">
        ...
        <div class="center" style="position: relative; left: 160px; bottom: 20px;">
            <form action="Registration2.jsp" style="font-family: Arial, Helvetica, sans-serif;">
                ...
                <div style="position: relative; top: 90px; left: 18px;">
                    <input type="checkbox" required />
                    <label for="checkbox" style="color: white;"> I agree to these <a href="#" id="tandc">Terms and Conditions</a>.</label> <br />
                </div>
                <button type="submit" class="submit" style="text-align: center; position: relative; top: 100px;"><span style="position: relative; right: 9px;">Sign Up</span></button>
            </form>
        </div>
    </div>
    <span style="color: #f02849; font-family: Arial, Helvetica, sans-serif; position: absolute; top: 498px; left: 517px;">The user id you have entered already exists.</span>
    <span style="color: #f02849; font-family: Arial, Helvetica, sans-serif; position: absolute; top: 518px; left: 517px;">Enter another user id.</span>
